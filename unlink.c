...
const char *explain_unlink_error(pool *p, int xerrno, const char *path,
    const char **args) {
  const char *explained = NULL, *syscall = "unlink(2)";
  int path_flags = EXPLAIN_PATH_FL_WANT_UNLINK;
